			...
			for messaging_event in messaging:
				...
				if messaging_event.get('message'):
					...
					if messaging_event['message'].get('text'):
						...
						response = requests.post(fb_api,params=token_dict, json={"message": [{"text": "hello"},{"text": "hello2"}], "recipient": {"id": sender_id}, "notification_type": "REGULAR", "messaging_type": "RESPONSE"})
						print(response)
